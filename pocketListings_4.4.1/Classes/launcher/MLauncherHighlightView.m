...
@implementation MLauncherHighlightView
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent*)event {
    ...
    if (CGRectContainsPoint(_highlightRect, [touch locationInView:self])) {
        ...
        if ([targetButton isKindOfClass:[MLauncherButton class]]) {
            [(MLauncherButton *)targetButton sendActionsForControlEvents:UIControlEventTouchUpInside];
        }
    }
