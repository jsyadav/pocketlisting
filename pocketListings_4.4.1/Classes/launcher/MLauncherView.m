...
#import "MLauncherScrollView.h"
#import "UIViewAdditions.h"
#import "MLauncherItem.h"
#import "MLauncherButton.h"
#import "MLauncherHighlightView.h"
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _scrollView = [[MLauncherScrollView alloc] initWithFrame:
        ...
        _pager = [[MPageControl alloc] init];
...
- (void)dealloc {
    for (NSArray* page in _pages) {
        for (MLauncherItem* item in page) {
            item.launcher = nil;
        }
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (MLauncherButton*)buttonForItem:(MLauncherItem*)item {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (NSMutableArray*)pageWithItem:(MLauncherItem*)item {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (NSMutableArray*)pageWithButton:(MLauncherButton*)button {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)updateItemBadge:(MLauncherItem*)item {
    MLauncherButton* button = [self buttonForItem:item];
...
- (void)updatePagerWithContentOffset:(CGPoint)contentOffset {
    ...
    if ([_delegate respondsToSelector:@selector(launcherView:pageChanged:)]) {
        [_delegate launcherView:self pageChanged:_pager];
    }
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (MLauncherButton*)addButtonWithItem:(MLauncherItem*)item {
    MLauncherButton* button = [[[MLauncherButton alloc] initWithItem:item] autorelease];
...
- (void)layoutButtons {
    ...
    for (NSMutableArray* buttonPage in _buttons) {
        CGFloat y = kMargin;
        for (MLauncherButton* button in buttonPage) {
...
- (void)recreateButtons {
    ...
    for (NSArray* page in _pages) {
        ...
        for (MLauncherItem* item in page) {
            MLauncherButton* button = [self addButtonWithItem:item];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)startDraggingButton:(MLauncherButton*)button withEvent:(UIEvent*)event {
    TT_INVALIDATE_TIMER(_springLoadTimer);
...
- (void)removeButtonAnimationDidStop:(NSString*)animationID finished:(NSNumber*)finished
    ...
    MLauncherButton* button = context;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)buttonTouchedUpInside:(MLauncherButton*)button {
    if (_editing) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)buttonTouchedUpOutside:(MLauncherButton*)button {
    if (_editing) {
        if (button == _dragButton) {
            [self startDraggingButton:nil withEvent:nil];
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)buttonTouchedDown:(MLauncherButton*)button withEvent:(UIEvent*)event {
    if (!self.editable)
        return;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)closeButtonTouchedUpInside:(MButton*)closeButton {
...
//    MLauncherButton* button = info.weakRef;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)deselectButton:(MLauncherButton*)button {
...
- (void)setPages:(NSArray*)pages {
    ...
    for (NSArray* page in pages) {
        ...
        for (MLauncherItem* item in pageCopy) {
            item.launcher = self;
        }
        [pageCopy release];
    }
...
- (void)beginHighlightItem:(MLauncherItem*)item withText:(NSString*)text {
    if (nil == _highlightView) {
        _highlightView = [[MLauncherHighlightView alloc] initWithFrame:CGRectZero];
    ...
    _highlightView.highlightRect = MRectInset([self.window convertRect:button.frame
