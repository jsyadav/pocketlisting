...
@interface ExteriorFeaturesList : 
  	NSObject
 {
	...
	NSString* exteriorFeature_var_XMLNAME;
...
@property (nonatomic,readwrite,retain) NSString* xmlString;
	   ...
	   @property (nonatomic,readwrite,retain) NSMutableArray* exteriorFeature_var;
	
	@property (readwrite,retain) NSString* exteriorFeature_var_XMLNAME;
