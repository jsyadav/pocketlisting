...
@interface EmailAddress : 
  	NSObject <XMLAble>
 {
	...
	NSString* emailAddress_var_XMLNAME;
...
@property (nonatomic,readwrite,retain) NSString* xmlString;
	...
	@property (readwrite,retain) NSString* type_var_XMLNAME;
	   @property (nonatomic,readwrite,retain) EmailAddress* emailAddress_var;
	
	@property (readwrite,retain) NSString* emailAddress_var_XMLNAME;
	   @property (nonatomic,readwrite,retain) NSNumber* id_var;
